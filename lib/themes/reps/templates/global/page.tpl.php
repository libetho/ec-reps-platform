...
?>
  ...
  <div id="layout-header">
    <div class="container">
      ...
      <div id="main-title"><?php print $site_slogan; ?></div>
      <div id="sub-title" class="hidden-xs"></div>
    </div>
  </div><!-- /#layout-header -->
  ...
  <div id="layout-body" class="container">
    ...
    <div class="row">
      ...
      <div id="sidebar-right" class="col-lg-<?php print ($cols['sidebar_right']['lg']); ?> col-md-<?php print ($cols['sidebar_right']['md']); ?> col-sm-<?php print ($cols['sidebar_right']['sm']); ?> col-xs-<?php print ($cols['sidebar_right']['xs']); ?> sidebar-right visible-lg visible-md visible-sm visible-xs">
